...
export const runway: ToolReview = {
  ...
  knownIssues: [
    {
      description: "GWM WORLDS 2 -- RUNWAY'S REAL-TIME WORLD MODEL GAINS AUDIO AND SUBJECT/SCENE CONTROL, STILL A RESEARCH PREVIEW (2026-09-03, vendor-primary; recorded 2026-09-14 on a staleness check -- this page was last reviewed 8/06 and had only the May GWM-1 note): Runway published **GWM Worlds 2**, 'the next iteration of our research to create interactive environments.' **What it does:** 'continuous **720p video at 24 fps and audio at 48,000 Hz**, responding to your inputs as you explore'; built 'on top of our foundational audio-video generation model', it turns generation into real-time simulation where you 'steer the world with text actions addressed to any subject or to the scene itself, alongside continuous camera motion' -- a sword slash, a spoken reply, a dust storm -- with no preset session length. **The input format is the research contribution:** **WorldPrompt**, which splits world state into a persistent 'genesis' layer (scene description, subjects with attributes, 'laws' from gravity to character abilities, plus a first frame) and a time-varying action stream. Demos show first-person play, director-style scene prompts, and both at once. **Stated targets:** interactive entertainment, virtual characters, robotics/embodied-agent simulation, generative interfaces. **STATUS: research preview, published under runwayml.com/research, not a product feature and not in the Gen-4.5 app or API.** This extends the December GWM Worlds and the May GWM-1 family; it does not change pricing, plans or the Gen-4.5 leaderboard position. Watch for productisation at Runway's AI Summit (9/30, San Francisco), which the page promotes.",
      source: "Runway Research (runwayml.com/research/introducing-gwm-worlds-2, JSON-LD datePublished 2026-09-03T10:00:00.000Z, on-page 'September 3, 2026') -- fetched 2026-09-14 via curl",
      date: "2026-09-03",
    },
    {
  ...
  dataSources: [
    { name: "Runway Research: Introducing GWM Worlds 2 -- real-time 720p/24fps + 48kHz audio interactive worlds, WorldPrompt (2026-09-03)", url: "https://runwayml.com/research/introducing-gwm-worlds-2", dateAccessed: "2026-09-14" },
