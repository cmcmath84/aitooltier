...
export const claude: ToolReview = {
  ...
  pricing: [
    ...
    },
    {
      plan: "API (Sonnet 5)",
      price: "$2 / $10",
      period: "per 1M tokens (input/output) -- NOW THE STANDARD PRICE; the scheduled 2026-09-01 rise to $3 / $15 was cancelled",
  ...
  metaDescription: "Claude review. Opus 5 (July 24) is the new default on Max and the strongest model on Pro at $5/$25 per 1M, which Anthropic says lands within 0.5% of Fable 5 on CursorBench at half the cost. Sonnet 5 stays the Free/Pro default at $2/$10 -- now permanent, after Anthropic cancelled the Sept 1 rise to $3/$15.",
};
