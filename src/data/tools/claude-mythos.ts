...
export const claudeMythos: ToolReview = {
  ...
  tagline: "Anthropic's unrestricted frontier model -- launched June 9, 2026 alongside Claude Fable 5 (the same model made safe for general use). Suspended June 12 by a US export-control order, then PARTIALLY RESTORED July 1, 2026 (US government lifted controls June 30): Mythos 5 is back for a set of US organizations with government approval, while Anthropic works to re-expand the broader Glasswing program. Public Fable 5 returned globally the same day. Gated to Project Glasswing orgs + select biology researchers.",
  category: "ai-llms",
  ...
  metaTitle: "Claude Mythos 5 (2026): Partially Restored July 1 After US Export-Control Suspension",
