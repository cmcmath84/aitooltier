...
export const cursor: ToolReview = {
  ...
  pricing: [
    ...
    },
    {
      ...
      price: "$20",
      period: "month",
      features: ["Unlimited completions", "500 premium requests/mo", "Composer 2 at $0.50/$2.50 per 1M tokens", "All frontier models"],
    },
    {
      plan: "Ultra",
      price: "$200",
      period: "month",
      features: ["20x Pro usage on Composer 2", "Highest priority queue", "Multi-workspace + Background Agents at scale"],
    },
    {
      plan: "Business",
      price: "$40",
      period: "month/user",
      features: ["Team controls, SAML SSO, privacy mode", "Agent Command Center", "Unlimited premium model usage"],
    },
  ],
