...
export const codex: ToolReview = {
  ...
  dataSources: [
    { name: "OpenAI official Codex page", dateAccessed: "2026-04-13" },
    { name: "developers.openai.com/codex/pricing", dateAccessed: "2026-04-13" },
    { name: "Reddit r/openai, r/programming", dateAccessed: "2026-04-13" },
    { name: "TechRadar security review", dateAccessed: "2026-04-13" },
    { name: "GitHub openai/codex issues", dateAccessed: "2026-04-13" },
  ],
