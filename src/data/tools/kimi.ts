...
export const kimi: ToolReview = {
  ...
  dataSources: [
    { name: "GitHub Changelog: Kimi K2.7 Code deprecated from Copilot 2026-10-02, K3 the suggested alternative (2026-09-03)", url: "https://github.blog/changelog/2026-09-03-upcoming-deprecation-of-selected-github-copilot-models/", dateAccessed: "2026-09-05" },
    ...
    { name: "Perplexity changelog: Shared workspaces, Personal Computer for Windows, and Model Council -- includes US-hosted Kimi K3 (2026-08-04)", url: "https://www.perplexity.ai/changelog/shared-workspaces-personal-computer-for-windows-and-model-council", dateAccessed: "2026-08-06" },
  ...
  metaTitle: "Kimi K3 Review 2026: 2.8T Open Weights, Now in Copilot and Perplexity",
  metaDescription: "Kimi K3 review. 2.8T parameters, 1M context, multimodal, $3/$15 per 1M. Weights shipped late July under the Kimi K3 License, and in early August K3 became selectable in GitHub Copilot (Fireworks-hosted) and Perplexity (US-hosted). Benchmarks, licence terms, caveats.",
};
