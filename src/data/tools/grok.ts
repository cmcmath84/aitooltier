...
export const grok: ToolReview = {
  ...
  dataSources: [
    { name: "SpaceXAI: Introducing Grok 4.6 -- $2/$6, full eval table, Cursor + Grok Build day one (2026-08-12)", url: "https://x.ai/news/grok-4-6", dateAccessed: "2026-08-13" },
    { name: "Cursor blog: Grok 4.6 (corroborates launch date, pricing and 2x first-week usage)", url: "https://cursor.com/blog/grok-4-6", dateAccessed: "2026-08-13" },
    { name: "SpaceXAI: Introducing Grok Bot -- always-on agents, SuperGrok Heavy + Cursor Ultra/Teams Premium (2026-08-11)", url: "https://x.ai/news/introducing-grok-bot", dateAccessed: "2026-08-13" },
