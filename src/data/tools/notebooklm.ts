...
export const notebookLm: ToolReview = {
  ...
  knownIssues: [
    {
      description:
        "GOOGLE HAS NOW PUBLISHED A DEDICATED LIMITS DOC -- AND IT REVEALS A WEEKLY CEILING THIS PAGE DID NOT CARRY (new help article found 2026-09-07; the compute-weighted limits themselves took effect 2026-09-02). The 9/05 review recorded the 5-hourly refresh and flagged that Google's help copy still read prospectively. Both of those still hold, but Google has since published a **separate, dedicated article** (support.google.com/gemininotebook/answer/17670842, 'Manage your Gemini Notebook usage limits') that the previous sweep did not have, and it changes the shape of the limit in a way that matters. **THE SENTENCE TO READ TWICE, VERBATIM:** 'If you\u2019ve hit your usage limits, you can come back later as the quota refreshes every 5 hours **until you reach your weekly limit**, or upgrade Gemini Notebook to get higher AI limits.' **SO THERE IS A WEEKLY CAP SITTING ON TOP OF THE 5-HOURLY REFRESH.** That is materially more restrictive than 'limits refresh every five hours' on its own, which is how this change has generally been described -- including on this page until now. The 5-hourly refresh is not an unlimited-if-you-wait mechanism; it is a rate limiter inside a weekly budget. **Google publishes no number for the weekly limit, for any tier.** **THE PLAN MULTIPLIERS, WHICH ARE NEW AND ARE RELATIVE, NOT ABSOLUTE:** no plan = 'Standard limits'; **AI Plus = 2x standard**; **AI Pro = 4x standard**; **AI Ultra = 5x or 20x higher than AI Pro depending on your subscription** (matching the 20 TB / 30 TB Ultra split). Because every figure is a multiple of an unpublished baseline, **you cannot compute what any tier actually gets** -- the ratios are disclosed and the base is not. **WHAT IS ACTUALLY OBSERVABLE IN-PRODUCT:** usage now appears under **Settings > Usage**; the chat footer shows remaining usage and a reset time ('You\u2019re almost at your AI usage limit. Limit resets at 3:00 PM.'); and Studio generation shows an **expected AI usage cost bar** before you commit to a generation. **'Generate later' is confirmed WEB-ONLY** -- 'This feature is currently only available on the web' -- and Google says deferred generations 'may take a couple hours'. **THE CAVEAT FROM 9/05 STANDS, UNCHANGED, AND IS NOW STRANGER:** both help articles STILL read '**Starting on September 2, 2026**' when fetched on 2026-09-07, five days after the date. Worse, the upgrade page (answer/16213268) **still publishes the old flat daily table** -- Chats 50/day, Audio Overviews 3/day, Reports 10/day -- with the footnote 'Daily quotas are reset after 24 hours', which directly contradicts the compute-weighted article sitting one click away. **Google is currently publishing two incompatible limit regimes simultaneously.** **DO NOT READ THAT AS A DELAY** -- there is still no announcement of a postponement and no revised date, and unedited help copy remains the likeliest explanation. But it is now a five-day-old inconsistency across two pages rather than a single stale sentence, so the honest position is unchanged: **treat 2026-09-02 as the effective date, treat the flat daily caps as gone, and verify against your own account before budgeting against any specific number.** **Flag for the next sweep: re-check both articles and drop this caveat once Google reconciles them.**",
      source: "Google Support: Manage your Gemini Notebook usage limits (support.google.com/gemininotebook/answer/17670842) and Upgrade Gemini Notebook (answer/16213268) -- both still reading 'Starting on September 2, 2026' and mutually inconsistent when fetched 2026-09-07 via Firecrawl",
      date: "2026-09-07",
    },
    {
  ...
  dataSources: [
    { name: "Google Support: Manage your Gemini Notebook usage limits -- 5-hourly refresh under a weekly limit, plan multipliers (still reads 'Starting on September 2, 2026' on 2026-09-07)", url: "https://support.google.com/gemininotebook/answer/17670842", dateAccessed: "2026-09-07" },
    { name: "Google Support: Upgrade Gemini Notebook -- still publishing the superseded flat daily caps table", url: "https://support.google.com/gemininotebook/answer/16213268", dateAccessed: "2026-09-07" },
  ...
  metaDescription: "Gemini Notebook review -- NotebookLM was renamed on 2026-07-16. Free source-grounded research AI with Audio Overviews, now with code execution, Expert Intelligence ebook sources, and compute-weighted limits in effect since 2026-09-02 that refresh every 5 hours under an undisclosed weekly cap (AI Plus 2x, Pro 4x, Ultra 5x-20x above Pro).",
};
