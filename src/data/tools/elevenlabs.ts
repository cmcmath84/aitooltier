...
export const elevenlabs: ToolReview = {
  ...
  knownIssues: [
    { description: "V1 MODEL REMOVAL DATE REACHED (2026-07-09): today is the scheduled removal date for **scribe_v1, eleven_monolingual_v1, and eleven_multilingual_v1** -- pinned API calls to these v1 model IDs should be treated as failing now or imminently. If you haven't migrated, switch to scribe_v2 (transcription) and eleven_multilingual_v2 (TTS) immediately. As of the morning of 7/9 the vendor models page still carried the 'will be removed on July 9th 2026' wording and no completion changelog entry had posted -- the removal is proceeding as scheduled with no scope or date changes announced. These are model deprecations, not voice-library removals; cloned/library voices are unaffected. Separately (7/6 changelog): the Agents 'Simulate conversation' endpoints are deprecated in favor of newer test endpoints, and the `disable_interruptions` param was replaced by `interruption_mode`", source: "ElevenLabs docs (elevenlabs.io/docs/overview/models -- checked 2026-07-09), ElevenLabs changelog (2026-07-06)", date: "2026-07-09" },
