...
export const chatgpt: ToolReview = {
  ...
  knownIssues: [
    ...
    { description: "API SHUTDOWN (2026-05-07, T-1 from today): The Realtime API Beta header (`OpenAI-Beta: realtime=v1`) is permanently removed tomorrow, alongside `gpt-4o-realtime-preview*`, `gpt-4o-mini-realtime-preview`, `gpt-4o-audio-preview`, and `gpt-4o-mini-audio-preview` snapshots. Migration: GA Realtime API + `gpt-realtime-1.5` / `gpt-realtime-mini` / `gpt-audio-1.5` / `gpt-audio-mini`. Active integrations that don't migrate by 5/7 will hard-fail. Distinct from the 4/22 legacy snapshot batch (which retires 7/23 + 10/23) -- this one is tomorrow", source: "OpenAI deprecation page (developers.openai.com/api/docs/deprecations)", date: "2026-05-07" },
