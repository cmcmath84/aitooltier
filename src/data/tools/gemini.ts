...
export const gemini: ToolReview = {
  ...
  knownIssues: [
    {
      description: "THE GEMINI APP COMES TO WINDOWS -- ALT+SPACE OVERLAY, GOOGLE-APP CONNECTORS AND GEMINI SPARK ON THE DESKTOP (2026-09-10, vendor-primary): Google shipped **the Gemini app for Windows**, downloadable from gemini.google/desktop, ten weeks after the macOS app got Gemini Spark (6/30). **What it is:** a native desktop app summoned with **Alt + Space** over whatever you are working in, for drafting, Q&A, image and video creation, and file organisation, designed (per Google) to 'run smoothly in the background so it won't slow down your computer.' The desktop landing page confirms the Windows build has the same three pillars as Mac: the shortcut overlay, **Gemini Spark** ('your 24/7 personal AI agent' for multi-step research, planning and synthesis), and **connectors to Gmail, Drive, Docs and Calendar** to pull information into the desktop workflow. **WHY IT MATTERS:** this closes the platform gap with ChatGPT's unified desktop app (Windows + Mac since 7/09) and with Microsoft Copilot's native Windows position -- Gemini is now resident on the OS Microsoft controls, with an overlay shortcut that competes directly with the Copilot key. Spark's tier gating (AI Ultra, 18+, US on Mac at its June launch) is not restated in the Windows post; assume the same until Google says otherwise. No pricing change.",
      source: "Google (blog.google/innovation-and-ai/products/gemini-app/gemini-app-now-on-windows/, root-RSS pubDate 'Thu, 10 Sep 2026 16:00:00 +0000', on-page 'Sep 10, 2026', by Erin Pettigrew); gemini.google/desktop (download page listing Alt+Space / Option+Space, Spark and Google-app connectors) -- both fetched 2026-09-14",
      date: "2026-09-10",
    },
    {
      description: "FALL AI-PLAN REFRESH -- GOOGLE PICS AND SHEETS CANVAS GATED TO AI PRO/ULTRA, GEMINI SPARK NOW REACHES INTO CHROME AND GOOGLE PHOTOS, VOICE IN GMAIL/DOCS/KEEP (2026-09-09, vendor-primary): Google's AI-subscriptions post lists what the tiers now include, and the tier lines are the useful part: **Voice** in Gmail, Docs and Keep to draft, search the inbox and capture notes -- **AI Plus, Pro and Ultra in Gmail and Keep; Pro and Ultra only in Docs**. **Google Pics in Google Workspace** (poster design, social posts, illustration editing) -- **AI Pro and Ultra**. **Sheets canvas** -- turn a spreadsheet into an interactive 'mini-app' from a prompt -- **AI Pro and Ultra**. **Gemini Spark 'now connected with Google Chrome and Google Photos'** to run web errands, edit photos and curate albums -- **AI Pro and Ultra, US only**, which is a broadening from Spark's Ultra-only macOS launch in June if it holds across surfaces. **Eligible college students worldwide get one year of a Google AI plan free.** **READ:** the pattern is consistent -- AI Plus gets voice and the basics, the agentic and creative features land at Pro ($19.99) and up, and Spark keeps expanding its reach (Chrome, Photos, now Windows) faster than its documented tier rules, so check the in-product gate before promising a feature to a Plus subscriber.",
      source: "Google (blog.google/products-and-platforms/products/google-one/fall-2026-ai-plan-updates/, root-RSS pubDate 'Wed, 09 Sep 2026 17:00:00 +0000', on-page 'Sep 09, 2026', by Vikas Kansal) -- fetched 2026-09-14",
      date: "2026-09-09",
    },
    {
      description: "GEMINI 3.8 FLASH AND 3.8 FLASH CYBER -- THE THIRD FLASH RELEASE IN SIX WEEKS, AND THE INTRO PRICE DID NOT RESET (2026-09-02, vendor-primary): Google shipped **Gemini 3.8 Flash** and **Gemini 3.8 Flash Cyber**, describing 3.8 as 'our best reasoning and coding model yet, at the same speed and low cost of 3.7' and noting this is its **third Flash release in only six weeks**, three weeks after 3.7 Flash. **PRICING -- AND THE TRAP IS THE SAME ONE 3.7 FLASH CARRIED, ON THE SAME DEADLINE:** 3.8 Flash is '**available at the same introductory price as 3.7 Flash at $0.75 per million input tokens and $3.75 per million output tokens**'. The footnote is explicit: '**Introductory price expires on December 31, 2026. Starting January 1, 2027, $1.50/1M input tokens and $7.50/1M output tokens will apply.**' **So the new model inherits the old model's expiry date rather than getting a fresh twelve months -- the discount window is now four months shorter than it was for anyone who adopted 3.7 Flash in August.** Budget on the January 1 doubling, not on today's rate. **BENCHMARKS, VENDOR-PUBLISHED:** **54.9% on HLE-Verified**; Google says 3.8 Flash 'outperforms most larger frontier models' on **DeepSWE v1.1** long-horizon software engineering 'at a fraction of the cost', and beats 3.7 Flash and other frontier models on **Vals Finance Agent V2** and **Harvey's Legal Agent Benchmark**. **AN HONEST COST CAVEAT GOOGLE PUBLISHES AND AGGREGATORS WILL DROP:** the gains come from the model '**working harder**' -- 'executing extra reasoning steps, and calling tools iteratively', and 'at times, the model might use more tokens to maximize performance, especially at higher effort levels'. **Same per-token price, potentially more tokens per task -- so the effective cost per task can rise even though the rate card did not move.** Google explicitly tells efficiency-first users to lower the effort level or **stay on 3.7 Flash, which 'remains fully supported'** -- so this is not a forced migration. **GEMINI 3.8 FLASH CYBER IS NOT PURCHASABLE:** it is available 'to a select set of trusted defenders' via the new **Fairwind Program**, aimed at trusted government authorities, critical-infrastructure operators and software maintainers, with prioritized access by application. Google reports frontier CyberGym performance at **2.3-5.2x lower cost than other leading frontier models**, and says its Cloud Vulnerability Research team used it to find a critical foundational vulnerability **in under two hours** where discovery normally takes months. **AVAILABILITY OF 3.8 FLASH (the one you can actually use):** developers via Google Antigravity, the Gemini API through Google AI Studio, Android Studio and Stitch; enterprises via Gemini Enterprise; consumers on **Google AI Pro and Ultra** across the Gemini app, AI Mode in Google Search, and Gemini in Google Sheets. **It reached GitHub Copilot the next day, 2026-09-03**, for Pro, Pro+, Max, Business and Enterprise.",
      source: "Google (blog.google/innovation-and-ai/models-and-research/gemini-models/3-8-flash-and-3-8-flash-cyber/, root-RSS pubDate 'Wed, 02 Sep 2026 15:00:00 +0000', on-page 'Sep 02, 2026') -- fetched 2026-09-05 via curl with browser UA",
      date: "2026-09-02",
    },
    {
  ...
  dataSources: [
    { name: "Google: The Gemini app is now available for Windows -- Alt+Space, Spark, Google-app connectors (2026-09-10)", url: "https://blog.google/innovation-and-ai/products/gemini-app/gemini-app-now-on-windows/", dateAccessed: "2026-09-14" },
    { name: "Google: Gemini for desktop download page -- Windows + macOS, Alt/Option+Space, Gemini Spark, Gmail/Drive/Docs/Calendar connectors", url: "https://gemini.google/desktop", dateAccessed: "2026-09-14" },
    { name: "Google: Tackle your to-do list with new features in our Google AI plans -- Voice, Google Pics, Sheets canvas, Spark + Chrome/Photos, tier gating (2026-09-09)", url: "https://blog.google/products-and-platforms/products/google-one/fall-2026-ai-plan-updates/", dateAccessed: "2026-09-14" },
    { name: "Google: Introducing Gemini 3.8 Flash and 3.8 Flash Cyber (2026-09-02) -- $0.75/$3.75 intro, expires 2026-12-31 then $1.50/$7.50; Fairwind Program for Cyber", url: "https://blog.google/innovation-and-ai/models-and-research/gemini-models/3-8-flash-and-3-8-flash-cyber/", dateAccessed: "2026-09-05" },
    { name: "GitHub Changelog: Gemini 3.8 Flash now available in GitHub Copilot, introductory provider pricing through 2026-12-31 (2026-09-03)", url: "https://github.blog/changelog/2026-09-03-gemini-3-8-flash-is-now-available-in-github-copilot/", dateAccessed: "2026-09-05" },
  ...
  metaTitle: "Gemini Review 2026: 3.8 Flash Lands at $0.75/$3.75 -- But the Intro Clock Did Not Reset",
  metaDescription: "Google Gemini review. Gemini 3.8 Flash (Sept 2, 2026) keeps the $0.75/$3.75 intro rate but inherits 3.7 Flash\u0027s Dec 31 expiry, then doubles to $1.50/$7.50. HLE-Verified 54.9%. Gemini 3.8 Flash Cyber is trusted-defenders-only via the Fairwind Program. Gemini 3.5 Pro still unshipped.",
};
