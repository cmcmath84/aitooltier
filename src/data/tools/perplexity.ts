...
export const perplexity: ToolReview = {
  ...
  knownIssues: [
    {
      ...
      source: "Perplexity blog (perplexity.ai/hub/blog/introducing-hybrid-compute-on-mac, dated Sep 1, 2026) -- fetched 2026-09-07",
      date: "2026-09-01",
    },
    {
      description:
      ...
      source: "Perplexity engineering blog (perplexity.ai/hub/blog/optimizing-on-device-inference-for-apple-silicon, dated Sep 1, 2026) -- fetched 2026-09-07",
      date: "2026-09-01",
    },
    {
  ...
  dataSources: [
    { name: "Perplexity: Introducing Hybrid Compute on Mac (2026-09-01)", url: "https://www.perplexity.ai/hub/blog/introducing-hybrid-compute-on-mac", dateAccessed: "2026-09-07" },
    { name: "Perplexity Engineering: Optimizing On-Device Inference for Apple Silicon -- the Lily engine (2026-09-01)", url: "https://www.perplexity.ai/hub/blog/optimizing-on-device-inference-for-apple-silicon", dateAccessed: "2026-09-07" },
  ...
  metaTitle: "Perplexity AI Review 2026: Hybrid Compute on Mac + On-Device Privacy Gate",
  metaDescription: "Perplexity AI review. Hybrid Compute on Mac (September 1 2026) splits each task between cloud frontier models and a local model, with an on-device privacy gate that can mask, withhold, refuse or ask consent. Runs on Lily, Perplexity's own Rust + Metal engine for Qwen3.6-35B-A3B. Plus Projects, Model Council and US-hosted Kimi K3.",
};
