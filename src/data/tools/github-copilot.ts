...
export const githubCopilot: ToolReview = {
  ...
  knownIssues: [
    {
      description: "COPILOT MOVES INTO SLACK AND MICROSOFT TEAMS -- AGENT SESSIONS BECOME MULTIPLAYER (2026-08-21, vendor-primary): GitHub shipped two chat-surface integrations in **public preview** on the same day. **Slack:** the GitHub integration now brings '**the agentic capabilities of GitHub Copilot CLI and the GitHub Copilot app into Slack**'. Mention **@GitHub** in a DM, channel or thread to start an agent session that can answer questions about code and GitHub activity, triage bug reports, create/update/label issues, and investigate failures then implement and validate changes. **GitHub is also a launch partner for Slack Code, a new Slack channel type designed for agents** -- worth watching as a category, not just a Copilot feature. **Microsoft Teams:** mention **@GitHub** to turn a discussion into a **shared Copilot cloud agent session that everyone in the conversation can see and steer**; anyone can ask questions and add context, but **only participants with write access to the repo can trigger Copilot to make changes** -- the governance boundary that makes this safe to enable. GitHub's framing is meeting-to-work: hand an action item to Copilot during standup and have it investigating before the meeting ends. **THE STRATEGIC POINT FOR RANKINGS: Copilot's agent is no longer editor-bound, and 'shared, observable agent session' is a collaboration primitive no editor-only assistant currently matches.** Both are previews, so treat durability as unproven.",
      source: "GitHub Changelog (github.blog/changelog/2026-08-21-the-new-github-copilot-experience-in-slack/ and github.blog/changelog/2026-08-21-shared-agentic-work-with-github-copilot-in-microsoft-teams/) -- both fetched 2026-08-28 via curl",
      date: "2026-08-21",
    },
    {
      description: "COPILOT HARNESS GA IN JETBRAINS, PLUS A BUILT-IN JETBRAINS MCP SERVER (2026-08-24, vendor-primary): **Copilot harness reached general availability in Copilot for JetBrains**, which GitHub credits with faster feature delivery and better code quality. Shipping alongside: **built-in JetBrains MCP server support in public preview**, exposing IDE capabilities to MCP-driven agent workflows **without requiring an external server setup** -- the friction that has kept most IDE MCP usage to early adopters. Also **/review harness integrations directly inside JetBrains**, and a What's New tab after plugin updates. **Read alongside the 2026-08-18 enterprise-managed-settings release for JetBrains: GitHub is closing the gap between its VS Code flagship and the JetBrains plugin on both agent capability and enterprise governance in the same fortnight.**",
      source: "GitHub Changelog (github.blog/changelog/2026-08-24-copilot-harness-generally-available-in-copilot-for-jetbrains/) -- fetched 2026-08-28 via curl",
      date: "2026-08-24",
    },
    {
      description: "GLOBAL MODEL POLICY GOES GA -- AND THE 8/17 WARNING NOT TO ASSUME IT AUTO-ENABLES EVERYTHING WAS CORRECT (2026-08-26, vendor-primary): The default model policy announced in July for Copilot Business/Enterprise began **gradual enforcement on 2026-08-26, rolling out through 2026-09-01**, so it takes effect at different times per enterprise. **We flagged on 2026-08-17 that this date should not be assumed to auto-enable Gemini 3.7 Flash and Grok 4.6. That caution is now confirmed, and the exclusion rule is broader and more interesting than model-by-model defaults:** GitHub excludes from default enablement (a) **all open-weight models -- it names DeepSeek and Kimi K2** and (b) **any model not covered by GitHub's data retention agreement -- it names Fable 5**, regardless of what an admin's policy is set to. **So the dividing line is licensing and data-retention posture, not capability or vendor prestige** -- an Anthropic frontier model and an open-weight Chinese model are excluded for different reasons but land in the same bucket. Unconfigured and newly-GA models inherit a **'Delegate to default policy'** state, a live setting that tracks the policy rather than freezing a value. **Explicit admin choices are preserved** -- deliberately enabled or disabled models are untouched. Four resulting states: Enabled, Disabled, Delegate to enterprise teams/apps or organizations, Delegate to default policy. **GitHub is consulting on removing 'Delegate to default policy' later** so every policy is an explicit decision.",
      source: "GitHub Changelog (github.blog/changelog/2026-08-26-global-model-policy-generally-available/, on-page 'August 26, 2026') -- fetched 2026-08-28 via curl",
      date: "2026-08-26",
    },
    {
      description: "COPILOT BUSINESS/ENTERPRISE SIGNUPS REOPEN 9/1 -- BUT SEATS MUST NOW BE PAID FOR BEFORE THEY WORK (2026-08-28, vendor-primary): GitHub published a slate of upcoming policy and billing changes. **The headline is that self-serve signups had been closed and are coming back: 'Starting September 1, 2026, GitHub will start reenabling sign-ups for new Copilot Business and Copilot Enterprise customers paying by credit card or PayPal,' with 'strengthened account vetting'** -- an anti-abuse measure, and an implicit admission the previous flow was being abused. **THE CHANGE THAT COSTS EXISTING CUSTOMERS MONEY IS THE SECOND ONE, AND IT IS NOT A PRICE RISE:** all new Business/Enterprise seat assignments will **require payment for each seat before users gain Copilot access**, and at the start of the next billing cycle **all assigned seats incur an upfront charge**. For existing credit-card/PayPal customers this begins **2026-10-01**. GitHub states plainly '**Copilot Business and Copilot Enterprise prices are not changing**' -- so this is a **cash-flow and provisioning change, not a rate change**, and anyone reading only the headline will get that backwards. **Retained terms:** mid-cycle seats still prorate; included usage may be prorated to match seat proration; overage still purchasable; spend controls, usage tracking and AI credits unchanged. **Retained sting: revoking a seat still yields no prorated refund**, which matters more now that seats are charged upfront. **SEPARATE DATED ITEM -- 'no earlier than September 28, 2026': Copilot cloud agent, Copilot Chat on github.com and Copilot Chat in GitHub Mobile converge into a single unified Copilot experience under one policy, enabled by default after launch**, with cloud agent moving onto Sandbox. Three separate admin policies collapse into one, and it defaults on -- worth flagging to anyone who had deliberately disabled just one of the three.",
      source: "GitHub Changelog (github.blog/changelog/2026-08-28-upcoming-changes-to-github-copilot-policies-and-billing/) -- fetched 2026-08-28 via curl",
      date: "2026-08-28",
    },
    {
      description: "ENTERPRISE MANAGED SETTINGS LAND IN COPILOT FOR JETBRAINS -- INCLUDING AN MCP ALLOWLIST AND A KILL SWITCH FOR AUTOPILOT (2026-08-18, vendor changelog): admin governance that had been VS Code-shaped now reaches JetBrains IDEs, and one of the four controls is more consequential than the changelog's flat tone suggests. **THE FOUR CONTROLS:** (1) **Plugin governance** -- `enabledPlugins` to force a plugin on or off, `extraKnownMarketplaces` to approve additional sources, `strictKnownMarketplaces` to limit installation to approved sources only. (2) **MCP server allowlist** -- `allowedMcpServers` and `deniedMcpServers` centrally control which MCP servers developers may connect to, which GitHub says '**prevents connections to servers outside the enterprise allowlist**'. (3) **Managed OpenTelemetry** -- admins set the collector endpoint, protocol, service name, resource attributes and content-capture policy, and '**managed values take precedence over developer settings**'. (4) **Organization-controlled permission modes** -- `permissions.disableBypassPermissionsMode` **prevents the Copilot agent in JetBrains from using Bypass Approvals or Autopilot**. **WHY (2) AND (4) ARE THE ONES TO CARE ABOUT:** an MCP server is arbitrary third-party code with tool access inside a developer's editor, and until now a JetBrains shop had no central way to bound which ones were reachable -- this closes a real supply-chain gap rather than adding a convenience toggle. And `disableBypassPermissionsMode` is the first documented way for an org to stop Copilot's agent from running unattended in JetBrains, which is the control a security review actually asks for. **SCOPE:** applies to enterprises on a Copilot plan, via the enterprise managed settings reference; requires the latest JetBrains plugin. No pricing change",
      source: "GitHub Changelog (github.blog/changelog/2026-08-18-enterprise-managed-settings-in-github-copilot-for-jetbrains/, date-prefixed slug, fetched 2026-08-20)",
      date: "2026-08-18",
    },
    {
      description: "MAI-CODE-1.1-FLASH ARRIVES AND MAI-CODE-1-FLASH IS ALREADY SCHEDULED TO DIE (both 2026-08-11, GitHub changelog) -- A ONE-MONTH FORCED MIGRATION. **(1) The new model.** MAI-Code-1.1-Flash, 'Microsoft's latest small-tier coding model', is rolling out in Copilot with **native vision support for image understanding**, improved coding quality and tool use. **Entitlement differs by plan in a way that matters: Free and Student users get it by automatic selection, while Pro, Pro+, Max, Business and Enterprise get it as a manual selection.** It carries a **0.25x premium request multiplier** for annual subscribers -- the cheapest multiplier in the picker -- and GitHub states a **73% lower list price than MAI-Code-1-Flash**, the model it replaces. **For Business and Enterprise the policy is OFF BY DEFAULT**, so an admin has to enable it. **(2) The retirement.** The same day, GitHub set **MAI-Code-1-Flash to retire on 2026-09-10**, across 'all GitHub Copilot experiences', individual and enterprise, with MAI-Code-1.1-Flash named as the suggested alternative. **The practical trap:** the replacement is off by default for orgs while the outgoing model has a hard date, so an Enterprise admin who does nothing leaves users with the old model until 9/10 and then with neither. Enable the 1.1 policy before the deadline. GitHub says 'no action is required to remove the older model once it has been deprecated' but does not spell out what happens to in-flight requests after the cutoff. **Note also that 9/10 sits after the 2026-08-26 auto-enablement change** -- MAI-Code-1.1-Flash is a first-party GA model, so it is the kind of model that policy is designed to auto-enable, but GitHub's own changelog still describes it as off by default today; do not assume the 8/26 flip retroactively covers it",
      source: "GitHub changelog (github.blog/changelog/2026-08-11-mai-code-1-1-flash-available-in-github-copilot/ and github.blog/changelog/2026-08-11-upcoming-deprecation-of-mai-code-1-flash/, both fetched 2026-08-13)",
      date: "2026-08-11",
    },
    {
      description: "COPILOT MEMORY + OLLAMA BYOK REACH JETBRAINS, AND PER-MODEL TOKEN BREAKDOWN LANDS IN BILLING (2026-08-11, GitHub changelog): **(1) Copilot memory in JetBrains** -- 'Copilot memory can now retain and recall useful information across agent chat sessions', so project details and preferences persist between conversations rather than being re-fed each time. **(2) Ollama as a BYOK provider in JetBrains** -- 'You can now use Ollama as a BYOK provider in GitHub Copilot for JetBrains', which means **local models running on your own machine inside Copilot's JetBrains client**. That is the meaningful one for anyone with data-residency constraints or a preference for open weights: it is a route to using Copilot's interface without sending code to a hosted frontier model. GitHub's changelog does **not** state which plans or SKUs these require -- recorded as unspecified rather than assumed to be all-plans. **(3) Per-model token breakdown in the usage report** -- 'You can now see a per-model breakdown of the tokens behind your AI credits in the usage report', showing **input, output, cache read and cache write tokens per model** alongside credits consumed, on **Business, Enterprise and Individuals**. This continues the metering-transparency thread that has been the most useful Copilot change since the 6/01 usage-billing cutover: cache read/write visibility in particular is what lets you tell whether a high bill is real work or cache misses",
      source: "GitHub changelog (github.blog/changelog/2026-08-11-copilot-memory-and-ollama-in-github-copilot-for-jetbrains/ and github.blog/changelog/2026-08-11-per-model-token-breakdown-in-the-usage-report/, both fetched 2026-08-13)",
      date: "2026-08-11",
    },
    {
      description: "AGENT PLUGINS 1.0 -- A VENDOR-NEUTRAL PACKAGING STANDARD FOR SKILLS + MCP SERVERS (announced 2026-08-12, spec published 2026-08-06, GitHub changelog): GitHub describes it as **'an open standard that packages agent skills and MCP servers into one installable plugin that is governed independently of any single vendor.'** The problem it solves is duplication: plugins previously needed **separate manifests and directory layouts for each client**, so one plugin now works across multiple agent clients instead of shipping vendor-specific versions. **Available in VS Code, Copilot CLI, the GitHub Copilot SDK and the GitHub Copilot app**, and **generally available on all Copilot plans**. **Not a breaking change** -- 'Existing GitHub Copilot plugins that don't target Agent Plugins 1.0 remain supported, with no migration required.' **Why it is worth watching beyond Copilot:** the 'governed independently of any single vendor' framing puts this in the same category as MCP itself, which GitHub also did not own but adopted -- if other agent clients implement it, plugin portability stops being a Copilot feature and becomes an ecosystem property. Whether that happens is not yet evidenced; today it is GitHub-published and GitHub-implemented",
      source: "GitHub changelog (github.blog/changelog/2026-08-12-agent-plugins-1-0-in-vs-code-copilot-cli-and-the-copilot-app/, fetched 2026-08-13)",
      date: "2026-08-12",
    },
    {
      description: "TWO FRONTIER MODELS LANDED IN THE PICKER IN 48 HOURS -- GEMINI 3.7 FLASH (8/13) AND GROK 4.6 (8/14), BOTH ON EVERY PAID SKU (vendor changelog, both fetched 2026-08-17): **(1) Gemini 3.7 Flash, 2026-08-13** -- GitHub added Google's newest Flash model **the same day Google launched it**, citing improvements in web/app development and agentic coding workflows. Availability: '**Copilot Pro, Pro+, Max, Business, and Enterprise users**' -- the broad list, including base Pro. **(2) Grok 4.6, 2026-08-14** -- xAI's latest coding model, which GitHub says '**performed especially well on longer-horizon tasks requiring sustained reasoning and tool use, making it a strong fit for complex coding workflows**.' Same SKU list: '**Copilot Pro, Pro+, Max, Business, and Enterprise SKUs**.' xAI published its own post the same day confirming it is 'now live in GitHub Copilot,' and noting the model is also available direct from the SpaceXAI console at **$2 per million input / $6 per million output** -- unchanged from Grok 4.5, so this is a capability bump at a flat price. **Surfaces for both:** VS Code, Visual Studio, Copilot CLI, the Copilot cloud agent, the GitHub Copilot app, JetBrains, Xcode and Eclipse. **ORG ADMINS -- BOTH ARE STILL OFF BY DEFAULT.** For Gemini 3.7 Flash, '**Copilot Enterprise and Copilot Business plan administrators must enable the Gemini 3.7 Flash Preview policy in Copilot settings before anyone in their organization can select it**' (note GitHub labels the policy **Preview**). For Grok 4.6, '**the policy is off by default**' for Business and Enterprise admins. xAI words it more loosely -- 'some businesses and enterprises will need to enable the model from Copilot settings' -- but GitHub's changelog is the authoritative one for org posture. **HOW THIS INTERACTS WITH THE 2026-08-26 DEFAULT-ENABLEMENT FLIP, because it is easy to get wrong:** the 8/26 change auto-enables newly released GA models covered by GitHub's data-retention agreement. Neither of these is automatically covered by that -- **Gemini 3.7 Flash is carrying a Preview policy label**, and both shipped **before** 8/26 with an explicit off-by-default posture, so **do not assume 8/26 retroactively switches them on**. If you want either model available to your org, enable it manually. **NO MULTIPLIER PUBLISHED FOR EITHER** -- GitHub's changelog states no premium-request multiplier and no context-window figure for Gemini 3.7 Flash or Grok 4.6, so any multiplier you see quoted for these two in an aggregator is not from the changelog. Both bill usage-based at provider list pricing, consistent with the Opus 5, Grok 4.5 and Kimi K3 adds. **Net:** the picker now spans five frontier vendors, and the two newest additions both arrived on day one or day two of their upstream launch -- Copilot's model-freshness lag is effectively gone",
      source: "GitHub changelog (github.blog/changelog/2026-08-13-gemini-3-7-flash-is-now-available-in-github-copilot and github.blog/changelog/2026-08-14-grok-4-6-is-now-available-in-github-copilot) plus SpaceXAI (x.ai/news/grok-4-6-github-copilot, on-page date Aug 14, 2026) -- all fetched 2026-08-17",
      date: "2026-08-14",
    },
    {
      description: "SPEND VISIBILITY FINALLY LANDS IN THE CHAT ITSELF (2026-08-10, vendor changelog) -- the single most useful change for anyone on usage-based billing: Copilot on the web (github.com/copilot) added **token spend indicators in chat**, giving you '**per-session and per-message quota**' and, in GitHub's words, 'greater visibility into your token spend and budget.' **Why this is more than a UI tweak on this page specifically:** since the 2026-06-01 billing cutover, every Copilot page here has carried the same structural complaint -- premium requests and credits burn in ways that are hard to see until the bill arrives, and the 8/03 reasoning-level control made that worse by adding a knob that 'consumes more tokens, and therefore more credits.' Per-message spend in the chat is the first in-context feedback loop on that. Availability: **all Copilot plans**. Shipped alongside the ability to **minimize a conversation and resume it** -- browse GitHub while a response is generating, then pick recent conversations back up. **A related transparency change shipped 2026-08-07 in the Copilot app:** '**Auto now shows which model handled each completed request, plus AI credit and cache details when they're available**' -- so Auto-mode routing, which previously gave you no way to know what you were billed for, is now itemised. Read together, these two are GitHub closing the metering-opacity gap rather than adding capability",
      source: "GitHub changelog (github.blog/changelog/2026-08-10-copilot-on-web-expands-conversation-controls/ and github.blog/changelog/2026-08-07-github-copilot-weekly-releases-august-3/, both fetched 2026-08-10)",
      date: "2026-08-10",
    },
    {
      description: "COPILOT CODE REVIEW EFFORT LEVELS GO GA, AND THE NAMES CHANGED (2026-08-07, vendor changelog): the **Lite** and **Balanced** effort levels for Copilot code review moved from public preview to **general availability** -- and note the rename, because it will break your muscle memory and any internal docs: **these were previously called Low and Medium**. You pick a level **per review** (Lite for routine changes, Balanced for complex or sensitive code), and **organization admins can set a default effort level across all repositories**. Timeline events and pull-request comments now display which effort level was applied, so reviewers can see whether a given review was a light pass or a deep one. Availability: **Copilot Pro, Pro+, Max, Business, and Enterprise** -- i.e. every paid tier, not the free tier. No additional cost was announced beyond existing subscriptions, but remember the standing gotcha on this page: since 2026-06-01 Copilot code review bills **twice** -- the premium request plus GitHub Actions runtime -- so a default of Balanced across every repo is a spend decision, not just a quality one",
      source: "GitHub changelog (github.blog/changelog/2026-08-07-copilot-code-review-effort-levels-are-generally-available/, fetched 2026-08-10)",
      date: "2026-08-07",
    },
    {
  ...
  dataSources: [
    { name: "GitHub Changelog: Shared agentic work with Copilot in Microsoft Teams (2026-08-21)", url: "https://github.blog/changelog/2026-08-21-shared-agentic-work-with-github-copilot-in-microsoft-teams/", dateAccessed: "2026-08-28" },
    { name: "GitHub Changelog: The new GitHub Copilot experience in Slack (2026-08-21)", url: "https://github.blog/changelog/2026-08-21-the-new-github-copilot-experience-in-slack/", dateAccessed: "2026-08-28" },
    { name: "GitHub Changelog: Copilot harness GA in Copilot for JetBrains (2026-08-24)", url: "https://github.blog/changelog/2026-08-24-copilot-harness-generally-available-in-copilot-for-jetbrains/", dateAccessed: "2026-08-28" },
    { name: "GitHub Changelog: Global model policy generally available (2026-08-26)", url: "https://github.blog/changelog/2026-08-26-global-model-policy-generally-available/", dateAccessed: "2026-08-28" },
    { name: "GitHub Changelog: Upcoming changes to Copilot policies and billing (2026-08-28)", url: "https://github.blog/changelog/2026-08-28-upcoming-changes-to-github-copilot-policies-and-billing/", dateAccessed: "2026-08-28" },
    { name: "GitHub Changelog: Enterprise managed settings in GitHub Copilot for JetBrains -- MCP allowlist, Autopilot kill switch (2026-08-18)", url: "https://github.blog/changelog/2026-08-18-enterprise-managed-settings-in-github-copilot-for-jetbrains/", dateAccessed: "2026-08-20" },
    { name: "GitHub changelog: MAI-Code-1.1-Flash available in GitHub Copilot -- 0.25x multiplier, vision, off by default for orgs (2026-08-11)", url: "https://github.blog/changelog/2026-08-11-mai-code-1-1-flash-available-in-github-copilot/", dateAccessed: "2026-08-13" },
    { name: "GitHub changelog: Upcoming deprecation of MAI-Code-1-Flash -- retires 2026-09-10 (2026-08-11)", url: "https://github.blog/changelog/2026-08-11-upcoming-deprecation-of-mai-code-1-flash/", dateAccessed: "2026-08-13" },
    { name: "GitHub changelog: Agent Plugins 1.0 in VS Code, Copilot CLI and the Copilot app -- GA all plans (2026-08-12)", url: "https://github.blog/changelog/2026-08-12-agent-plugins-1-0-in-vs-code-copilot-cli-and-the-copilot-app/", dateAccessed: "2026-08-13" },
    { name: "GitHub changelog: Copilot memory and Ollama BYOK in Copilot for JetBrains (2026-08-11)", url: "https://github.blog/changelog/2026-08-11-copilot-memory-and-ollama-in-github-copilot-for-jetbrains/", dateAccessed: "2026-08-13" },
    { name: "GitHub changelog: Per-model token breakdown in the usage report -- Business/Enterprise/Individuals (2026-08-11)", url: "https://github.blog/changelog/2026-08-11-per-model-token-breakdown-in-the-usage-report/", dateAccessed: "2026-08-13" },
    { name: "GitHub changelog: Copilot on web expands conversation controls -- token spend indicators, all plans (2026-08-10)", url: "https://github.blog/changelog/2026-08-10-copilot-on-web-expands-conversation-controls", dateAccessed: "2026-08-10" },
    { name: "GitHub changelog: Copilot code review effort levels are generally available -- Lite/Balanced, Pro through Enterprise (2026-08-07)", url: "https://github.blog/changelog/2026-08-07-copilot-code-review-effort-levels-are-generally-available", dateAccessed: "2026-08-10" },
    { name: "GitHub changelog: Copilot weekly releases August 3 -- Auto shows model + AI credit/cache details (2026-08-07)", url: "https://github.blog/changelog/2026-08-07-github-copilot-weekly-releases-august-3", dateAccessed: "2026-08-10" },
    ...
    { name: "GitHub changelog: Grok 4.6 is now available in GitHub Copilot (2026-08-14) -- all paid SKUs, policy off by default for orgs", url: "https://github.blog/changelog/2026-08-14-grok-4-6-is-now-available-in-github-copilot", dateAccessed: "2026-08-17" },
    ...
    { name: "SpaceXAI: Grok 4.6 in GitHub Copilot (2026-08-14) -- $2/$6 per 1M direct from the console, unchanged from Grok 4.5", url: "https://x.ai/news/grok-4-6-github-copilot", dateAccessed: "2026-08-17" },
  ...
  status: "active",
  poweredBy: "Multi-model picker: Grok 4.6 (all paid SKUs, added 2026-08-14), Gemini 3.7 Flash (all paid SKUs, added 2026-08-13, Preview policy), MAI-Code-1.1-Flash (added 2026-08-11), Kimi K3 (Pro/Pro+/Max/Business/Enterprise, added 2026-08-06, GitHub-hosted on Fireworks AI), Claude Opus 5 (Pro+/Max/Business/Enterprise, added 2026-07-24), Grok 4.5 (all paid SKUs, added 2026-07-28), Kimi K2.7-Code, plus the GPT-5.x line",
  metaTitle: "GitHub Copilot Review 2026: Grok 4.6 + Gemini 3.7 Flash Land in the Picker",
  metaDescription: "GitHub Copilot review. Gemini 3.7 Flash (Aug 13) and Grok 4.6 (Aug 14) joined the picker across Pro, Pro+, Max, Business and Enterprise -- both still off by default for orgs, no multiplier published. Plus Kimi K3 (Aug 6), MAI-Code-1.1-Flash (Aug 11), the Sept 1 deprecation slate, and the Aug 26 default-model flip.",
};
