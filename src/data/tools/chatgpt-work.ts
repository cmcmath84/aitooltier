...
export const chatgptWork: ToolReview = {
  ...
  knownIssues: [
    {
      description: "THE ADMIN PLUGIN -- WORKSPACE ADMINISTRATION BECOMES A CONVERSATION (2026-08-25, vendor-primary): OpenAI shipped the **Admin plugin for ChatGPT Work and Codex**, letting an admin '**ask a question, explore the details, make an authorized change, and confirm the result**' in one conversation instead of moving between analytics, settings and reports. **Capabilities are genuinely write-scoped, not read-only dashboards:** review activity and credit usage across ChatGPT Work and Codex and spot members or groups approaching credit limits; **add or remove members**, update groups, run onboarding/offboarding; review effective permissions, diagnose access issues, and **control feature or model access by role or group**; and **adjust usage limits and approve or deny spending requests** against current usage. It also automates recurring workflows without custom engineering -- routing pending usage requests into **Slack or Microsoft Teams** for authorized reviewers to approve in place, and auto-granting feature access when requests meet policy. **THE THING TO WATCH IS THE BLAST RADIUS: this is an LLM with authority to change permissions, remove members and approve spend.** OpenAI's stated guardrail is that actions are 'supported' and 'authorized' and that it scales *existing* controls rather than replacing them -- but no independent audit trail or rollback story is described in the announcement, and that is the question an enterprise buyer should ask first. **Strategic read: this is ChatGPT Work's plugin directory being used for platform administration, the same vertical-channel pattern as the August education plugin bundle.**",
      source: "OpenAI (openai.com/index/introducing-admin-plugin/, publicationDateText 'August 25, 2026'; checked for 'Originally published on' / 'Update on' blocks -- none present, this is a genuine new post) -- fetched 2026-08-28 via curl with browser UA",
      date: "2026-08-25",
    },
    {
      description: "CHATGPT FOR TEACHERS ADDS 55 SCHOOL SYSTEMS AND A 16-STATE PRIVACY AGREEMENT (2026-08-26, vendor-primary): OpenAI expanded ChatGPT for Teachers to **55 additional school systems across 20 states**, reaching **over 100,000 more educators and staff**. Running totals from OpenAI: **more than 100 K-12 organizations across 30 states, over 300,000 educators and staff**, up from the roughly 150,000 at the 2025 launch. The new cohort includes **1 in 5 of America's 20 largest public school districts**. **THE STRUCTURALLY IMPORTANT PART IS NOT THE HEADCOUNT, IT IS THE PROCUREMENT UNLOCK: OpenAI announced a data privacy agreement spanning 16 states, which it calls 'a first for the industry'** -- a common framework letting districts evaluate ChatGPT for Teachers against student-data-privacy requirements without negotiating bilaterally. Student privacy review is the usual thing that stalls district AI adoption for a year, and a multi-state template is a far bigger lever on adoption than any feature. **Terms to hold onto: ChatGPT for Teachers remains free for verified U.S. K-12 educators through June 2028**, and access '**continues to be available to administrators, faculty, and educators only**' -- not students. **Read against the 2026-08-18 ChatGPT for Teens launch: OpenAI is building separate, differently-governed products for the two halves of a school building rather than one education SKU.**",
      source: "OpenAI (openai.com/index/bringing-chatgpt-for-teachers-to-more-us-school-districts/, publicationDateText 'August 26, 2026') -- fetched 2026-08-28 via curl with browser UA",
      date: "2026-08-26",
    },
    {
      description: "DATED-FLIP CHECK -- THE PREMIUM-SEAT PROMO EXPIRED WITHOUT THE SEATS EVER SHIPPING (re-verified 2026-08-20, vendor-primary): the $125 Premium seat recorded below was announced 2026-08-10 with a launch promotion that OpenAI said '**ends on August 20**'. We re-fetched the announcement on 2026-08-20, the day it lapsed. **Nothing has changed on the page**: the title is still '**Premium seats are coming to ChatGPT Business**' (future tense), the only call to action is still '**Join the waitlist**', and there is still **no GA date, no early-access list and no eligibility criteria published**. **THE PRACTICAL CONSEQUENCE, WHICH IS THE WHOLE POINT OF TRACKING THIS:** the promotion was **$100 in workspace credits per Premium seat, up to 5 seats / $500, for the first 10,000 eligible Business customers** -- but you could only qualify by **joining the waitlist**, and the seats you would spend the credits on **were never generally available during the ten days the offer ran**. So the deadline that just passed was a deadline to *register interest*, not a deadline to buy. If you joined the waitlist before today, hold OpenAI to the credits when the seats do ship; if you did not, there is currently **no published way to get them**. **FOR WORK USERS SPECIFICALLY:** the five-hour usage limit and the shared Work/Codex usage pool documented on this page are the pain the Premium seat is meant to relieve, and that relief is **still unavailable at any price** -- plan capacity on the Standard seat accordingly rather than around an imminent upgrade",
      source: "OpenAI (openai.com/index/premium-seats-chatgpt-business/, publicationDateText 'August 10, 2026', page state re-verified unchanged 2026-08-20 via curl)",
      date: "2026-08-20",
    },
    {
  ...
  dataSources: [
    ...
    { name: "OpenAI: Bringing ChatGPT for Teachers to more U.S. school districts (2026-08-26)", url: "https://openai.com/index/bringing-chatgpt-for-teachers-to-more-us-school-districts/", dateAccessed: "2026-08-28" },
