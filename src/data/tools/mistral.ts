...
export const mistral: ToolReview = {
  ...
  metaDescription: "Mistral review. EUR 3B Series D at a EUR 21B+ post-money valuation (Sept 8 2026, Samsung-led). Le Chat became Vibe; Medium 3.5 (128B dense, 256k, SWE-Bench 77.6%) is the default. Plus Shieldstral, Small 4, Voxtral TTS and a cheap API at $1.5/$7.5 per 1M.",
};
